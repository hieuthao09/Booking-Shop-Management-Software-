    ...
    public partial class frmLogin : Form
    {
        ...
        private void ptb_DangNhap_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (String.Compare(a.tentaikhoan, "Admin", true) == 0)
                {
                    nva.TENTAIKHOAN = "ADMIN";
                    nva.HOTEN = "ADMIN";
                    nva.NGAYSINH = DateTime.Now;
                    nva.SDT = "000";
                    nva.PHANQUYEN = 0;
                }
                else
                    nva = nvbll.Thongtinnhanvien(a.tentaikhoan)[0];
                if (tk.kiemTraDN(a) && String.Compare(a.tentaikhoan, "Admin", true) == 0)
                {
